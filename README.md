...
* Zunächst werden alle in der Bibliothek umzusystematisierenden Werke über einen SQL-Befehl in einer [csv-Datei](https://github.com/adalka/Malis18_T9.2_Automatisierte_Schlagwort_RVK-Notationsvergabe/blob/master/P1000_sortiert_mit_ISBN.csv) erfasst. Diese wurde nach Spalten (Signaturen, Mediennummern, Kurztitel, Autor, Reihentitel, ISBN, neue Notation, neue Schlagwörter, neue Gesamtsignatur) und nach Signaturen aufsteigend sortiert.
